// 💾 src/pages/PrivacyPolicyPage.jsx (PEŁNA WERSJA)

import React from 'react';

// Dodajemy trochę podstawowych stylów, aby strona nie była "naga"
const pageStyles = {
    padding: '20px',
    maxWidth: '900px',
    margin: '0 auto',
    ...
    return (
        <div style={pageStyles}>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Application</strong> refers to Testaplikacji, the software program provided by the Company.</p>
                </li>
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Testaplikacji.</p>
                </li>
                <li>
            ...
            <ul>
                <li>
                    By visiting this page on our website: <a href="https://testserwera.pl/" rel="external nofollow noopener noreferrer" target="_blank">https://testserwera.pl/</a>
                </li>
            </ul>
        </div>
    );
